...
const DEFAULTS = {
  ...
  services_description: 'Custom cleaning programs built around your schedule.',

  // "Who We Serve" card titles, in fixed display order — one per photo
  // card on the homepage. The photo/icon per card stays fixed in the
  // page's own code; only the title text is CMS-editable.
